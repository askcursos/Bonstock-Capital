	jQuery(document).ready(function($) {
		  ...
		  jQuery("#light").click(function(){
		   ...
		   jQuery("#h-one").click(function(){
			  	jQuery(".h-one-h").show();
				jQuery(".h-two-h").hide();
				jQuery(".h-three-h").hide();
				jQuery(".main-banner").removeClass("margin-0");
				jQuery("body").removeClass("two");
				jQuery("body").removeClass("three");
		   });
		   ...
		   jQuery("#h-three").click(function(){
			  	jQuery(".h-one-h").hide();
				jQuery(".h-two-h").hide();
				jQuery(".h-three-h").show();
				jQuery(".main-banner").addClass("margin-0");
				jQuery("body").removeClass("two");
				jQuery("body").addClass("three");
		   });
